...
CREATE TABLE IF NOT EXISTS admins (
  ...
  login_slug VARCHAR(120) NOT NULL DEFAULT 'admin-login',
  ...
  UNIQUE KEY uq_admin_login_slug (login_slug)
...
CREATE TABLE IF NOT EXISTS products (
  ...
  INDEX idx_products_status_category (
    status,
    category
  ),
...
CREATE TABLE IF NOT EXISTS contact_messages (
  ...
  INDEX idx_messages_status_created (
    status,
    created_at
  )
